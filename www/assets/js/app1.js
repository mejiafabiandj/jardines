var map, featureList, boroughSearch = [], theaterSearch = [], museumSearch = [], devlon, devlat;
...
map.on('click', function(e) {
    params = {
        "stops": "-74.05572652816772,4.685715647079643;" + e.latlng.lng + "," + e.latlng.lat
    }
...
function onLocationFound(e) {
    ...
    L.marker(e.latlng).addTo(map)
        .bindPopup("Bienvenido! (" + radius + "m)").openPopup();
